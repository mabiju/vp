...
namespace EmployeeFormsApp.employee_dbDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([empname]) VALUES (@empname);\r\nSELECT empid, empnam" +
                "e FROM employee WHERE (empid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[employee] SET [empname] = @empname WHERE (([empid] = @Original_empi" +
                "d) AND ([empname] = @Original_empname));\r\nSELECT empid, empname FROM employee WH" +
                "ERE (empid = @empid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EmployeeFormsApp.Properties.Settings.Default.employee_dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT empid, empname FROM dbo.employee";
        ...
        public virtual int Fill(employee_dbDataSet.employeeDataTable dataTable) {
        ...
        public virtual employee_dbDataSet.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            employee_dbDataSet.employeeDataTable dataTable = new employee_dbDataSet.employeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(employee_dbDataSet.employeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_empid, string Original_empname) {
        ...
        public virtual int Update(string empname, int Original_empid, string Original_empname, int empid) {
            if ((empname == null)) {
                throw new global::System.ArgumentNullException("empname");
            }
            else {
            ...
            if ((Original_empname == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_empname));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string empname, int Original_empid, string Original_empname) {
            return this.Update(empname, Original_empid, Original_empname, Original_empid);
        }
    }
